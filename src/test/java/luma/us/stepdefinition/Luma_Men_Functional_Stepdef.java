...
import luma.us.generics.LumaCommonUtilitys;
import luma.us.generics.HighLightElements;
import luma.us.generics.WaitHelper;
import luma.us.pagefactory.LumaLoginAndPurchase;

public class Luma_Men_Functional_Stepdef extends LumaBasePage {

	LumaLoginAndPurchase pf;
	...
	public void user_already_logged_in_the_application_and_verify_the_user_information_on_the_landing_page() {
		pf = PageFactory.initElements(driver, LumaLoginAndPurchase.class);
		// LumaLoginAndPurchase pf = new LumaLoginAndPurchase(); //another way 
		...
		// getAttribute()
		LumaCommonUtilitys.getAssert(expected, actual);
	...
	public void users_should_be_able_to_select_jupiter_all_weather_trainer_jacket_from_men_module() {
		...
		LumaCommonUtilitys.mouseHover(pf.getMenModule());
		...
		LumaCommonUtilitys.mouseHover(pf.getSelectTops());
		...
		LumaCommonUtilitys.getJSClick(pf.getSelectJacket());
	...
	public void verify_the_jacket_name_jupiter_all_weather_trainer_on_the_list() {
		...
		LumaCommonUtilitys.getJSClick(pf.getSelectJupiterJacket());
	...
	public void user_should_be_able_to_select_the_s_and_blue_and_then_click_on_the_add_to_cart(Integer int1) {
		...
		LumaCommonUtilitys.getJSClick(pf.getSelectSize());
		...
		LumaCommonUtilitys.getJSClick(pf.getSelectColor());
		...
		LumaCommonUtilitys.getJSClick(pf.getAddToCart());
	...
	public void user_should_be_able_to_click_on_the_cart() {
		...
		LumaCommonUtilitys.getJSClick(pf.getClickOnShoppingCart());
	}
	...
	public void user_should_be_able_to_click_on_the_checkout() {
		...
		LumaCommonUtilitys.getJSClick(pf.getClickProceedToCart());
	}
	...
	public void user_should_be_able_to_enter_the_shipping_details_and_click_on_the_next() {
		...
		LumaCommonUtilitys.getJSClick(pf.getClickAddNewAddress());
	}
