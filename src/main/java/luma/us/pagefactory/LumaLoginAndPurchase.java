...
public class LumaLoginAndPurchase extends LumaBasePage {
	// How to initialize pagefactory concept?

	public LumaLoginAndPurchase() {
	...
	public void addShippingDetails() {
		...
		LumaCommonUtilitys.getSelectValue(getSelectStateName(), "New Jersey");
		...
		LumaCommonUtilitys.getActionClick(getClickOnNext());
		...
		LumaCommonUtilitys.getJSClick(getClickOnPlaceOrder());
	...
	public void getLogin() {
		...
		LumaCommonUtilitys.getActionClick(getClickSignInBTN());
		...
		LumaCommonUtilitys.getActionClick(getClickLogin());
